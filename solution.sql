...
VALUES(2,'Ahmed','ahmed.wa','MET','D001')
...
--INSERT INTO Instructor(instructor_id,name,email,faculty,office)
--Values(1,'Omar','omar.ahmed@guc','MET','d1001')
...
SELECT * FROM Graduation_Plan
--INSERT INTO Graduation_Plan(Semester_code,expected_grad_date,student_id,semester_credit_hours)
--Values('S24',CURRENT_TIMESTAMP,1,30)
--SELECT * FROM Graduation_Plan
Go
...
GO
EXEC [Procedures_AdvisorAddCourseGP] 1 ,'S24','Mathematics 2'
SELECT * FROM GradPlan_Course
--SELECT * FROM Course
...
--SELECT * FROM Request
--UPDATE Student Set gpa=2.7 WHERE student_id=1
/*
...
Output: Table 
*/
--EXEC [Procedures_AdvisorViewAssignedStudents] 5 ,'Met'
Go
...
--SELECT * FROM dbo.FN_SemsterAvailableCourses('S24')
Go
...
--Output: deadline date of first upcoming
...
return @eligable
END
--select * from dbo.FN_StudentCheckSMEligibility(1,1,'S24')
-------------------------------------------
...
--SELECT * FROM Student
--INSERT INTO Student(f_name,l_name,password,faculty,financial_status,semester)
--VALUES('Ahmed','Omar','112233','ENG',1,5)
Go
